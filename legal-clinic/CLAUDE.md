...
**督导律师：** [PLACEHOLDER — 姓名、执业律师证编号、注册省（市）律师协会]
**学生实习规则依据：** [PLACEHOLDER — 例如，《律师执业管理办法》（2016年）第十六条（实习律师规定）；所在省（市）法律援助实施办法；学校-诊所合作协议中的学生实习条款]
**法律依据：** 《法律援助法》（2021）+ 《律师执业管理办法》（2016）+ 所在省市法律援助实施办法
...
| 集成 | 状态 | 不可用时的备用方案 |
|---|---|---|
| 案件管理系统（飞书项目 / 钉钉项目 / 简道云 / 泛微 OA）| [✓ / ✗] | 案件元数据记录在本地接案/状态文件中；无自动同步 |
| 文档存储（飞书云文档 / 钉钉文档 / 企业微信 / Google Drive）| [✓ / ✗] | 学生输出保存至本地文件系统；审查留在 plugin 内 |
...
**执业领域：** [PLACEHOLDER — 劳动争议 / 刑事辩护 / 婚姻家庭 / 消费者维权 / 土地房屋（征地拆迁）/ 行政诉讼 / 其他] *（来自 company-profile.md——在那里编辑以在所有 plugin 中更改）*
...
**省（市）：** [PLACEHOLDER] *（来自 company-profile.md——在那里编辑以在所有 plugin 中更改）*
**主要法院：** [PLACEHOLDER — 所在地区基层人民法院/中级人民法院]
...
**中国法框架下的保密制度说明。** `[AI 辅助草稿——需要学生分析和律师审查]` 标签将输出标记为律师督导下的工作，但需注意：

- **中国内地：** 律师保密义务依据《律师法》第三十八条，属于职业义务而非证据特免权。中国法律不存在美国法律体系下的 attorney-client privilege 和 work product doctrine（FRCP 26(b)(3)），也没有英国法下的诉讼特权制度。法院、检察机关、行政机关可依法调取特定材料。
- **诊所学生工作产品：** 学生实习律师在督导律师指导下完成的工作底稿，其保密性依托于律师-委托人保密义务。工作底稿在督导律师审查批准前不得对外发送或使用。
- **法律援助事项：** 依据《法律援助法》第三十一条，法律援助机构应保守在提供法律援助活动中知悉的受援人的商业秘密和个人隐私。

**跨境事务：** 涉港澳台、境外仲裁或外国法院诉讼时，督导律师应确认适用的特免权/保密制度，必要时将标签替换为 `保密 — 内部法律分析 — 不能替代外部律师意见`。
...
> **⚠️ 审阅者注释**
> - **来源：** [元典·法规 ✓ 已核验 | 元典·案例 ✓ 已核验 | 未连接——引用来自训练知识，依赖前请核实]
...
如果一切均为绿色（研究工具已连接、完整阅读、无标记、已检查时效性），折叠为一行：`⚠️ 审阅者注释：元典已核验 · 完整阅读 · 无标记 · 可供审阅`。不要用都写着"无问题"的项目符号填充。

**下面的可交付成果是干净的。** 没有横幅、没有内联元注释、没有跟踪器状态叙述（"已添加到登记册……"——去做，不要叙述）。内联标记是最小的：只有 `[审阅]` 在需要律师判断的特定行上，以及来源标记（`[模型知识—请核验]`）仅在引用出现的地方。审阅者需要做些什么的所有内容都被标记为 `[审阅]`；其他所有内容只是内容。
